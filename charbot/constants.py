...
GENERAL_CATEGORY = 360820301157629952
VIP_CATEGORY = 360819195904262144
...
LEVEL_ROLE_IDS_LIST = [LEVEL_1_ID, LEVEL_2_ID, LEVEL_3_ID, LEVEL_4_ID, LEVEL_5_ID, LEVEL_6_ID]
LEVEL_ROLE_IDS = frozenset(LEVEL_ROLE_IDS_LIST)
...
HONEYPOT_ROLE_IDS = 1488651790357631128
HONEYPOT_ROLES_IDS = frozenset(
    [
        NOSY_ROLE,
        HONEYPOT_ROLE_IDS,
        605419188873330739,  # Alerts
        1467285935619047639,  # Star Citizen
    ]
)
HONEYPOT_EXCLUDED_ROLE_IDS = MOD_ROLE_IDS | IRL_ROLE_IDS | LEGACY_ROLE_IDS | SUPPORTER_ROLE_IDS
HELPER_ROLE_ID: int = ...  # TODO: Add role ID here
