    ...
    async def on_dm_message(event: hikari.DMMessageCreateEvent) -> None:  # pylint: disable=unused-variable
        if event.is_human:
            await event.author.send(
                "Hi! If this was an attempt to reach the mod team through modmail, you've messaged the wrong bot sadly. Please message <@406885177281871902> (CharB0T#3153) instead. We apologize for the confusion of having 2 identically named bots, and hope you will still reach out if you were meaning to!")
