...
giveaway-check-success = ¡Tienes entradas de { $bid } ofertas, dándote un { NUMBER($chance, style: "percent", maximumFractionDigits: 2, minimumFractionDigits: 2) } oportunidad de ganar, y has ganado { $wins }/3 regalos puedes este mes!
