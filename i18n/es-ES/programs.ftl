# Command Groups
programs-name = programas
programs-description = Programas para ganar representación.
programs-beta-name = beta
programs-beta-description = Programas beta..
# Commands
programs-sudoku-name = sudoku
programs-sudoku-description = Juega un rompecabezas Sudoku
programs-sudoku-parameter-mobile-name = móvil
programs-sudoku-parameter-mobile-description = Desactivar el formato que sólo funciona en el ordenador.
...
programs-shrugman-name = marrón
programs-shrugman-description = Juega al minijuego de Shrugman. (clon Hangman)
...
rollcall-description = Reclama tu bonificación diaria de reputación.
repuation-name = reputación
repuation-description = Compruebe su reputación.
