...
minesweeper-select-row-placehholder = Selecteer een rij
minesweeper-select-col-label = Kolom { $letter }
minesweeper-select-col-description = Verander de kolom naar { $letter }
minesweeper-select-col-placehholder = Selecteer een kolom
...
minesweeper-lose-hit-cap-description = { lose-description } (Dagelijkse cap behaalt)
...
minesweeper-win-hit-cap-description = { win-description } (Dagelijkse cap behaalt)
